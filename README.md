...
Имя сети `MyHotspot` — условное. Подставьте своё в командах создания
точки доступа и в последующих проверках.
...
Подключите телефон к сети `MyHotspot` и убедитесь, что он получил
...
3. Убедитесь, что точка доступа `MyHotspot` работает.
